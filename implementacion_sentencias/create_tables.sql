...
-- Tabla con todas las muestras del proyecto. Cada paciente tiene mas de una muestra, como mucho una en cada tramo.
-- No todos los paciente tienen muestras en todos los tramos
-- Cada muestra tiene un numero de protocolo identificatorio, sumado a un ID de la tabla
