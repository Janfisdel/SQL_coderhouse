...
-- La primera tabla incluye el listado de todos los pacientes en el tratamiento con sus datos personales y un numero que se le agregó para identificarlos
